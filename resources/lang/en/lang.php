...
',
  ...
  'You can manage all your storage files from' => 'You can manage all your storage files from',
  'Select a storage model to manage and store files properly' => 'Select a storage model to manage and store files properly',
  'Select storage connection model' => 'Select storage connection model',
  'Do you want to switch 3rd party storage to local storage ?' => 'Do you want to switch 3rd party storage to local storage  ',
  'If you switch this newly uploaded created files & data will store to local storage' => 'If you switch this newly uploaded created files & data will store to local storage',
  ...
  'If enable this, newly uploaded/created files and data will store to local
                                                                            ...
                                                                            storage.',
  'Do you want to switch local storage to 3rd party storage?' => 'Do you want to switch local storage to 3rd party storage ',
  ...
  'OTP Setup' => 'OTP Setup',
  'Manage the settings for OTP and login attempt policies' => 'Manage the settings for OTP and login attempt policies',
  'Set the maximum number of incorrect OTP attempts allowed. After reaching the limit, the user will be temporarily blocked.' => 'Set the maximum number of incorrect OTP attempts allowed. After reaching the limit, the user will be temporarily blocked.',
  'Set the time for requesting a new OTP.' => 'Set the time for requesting a new OTP.',
  'Users will be unable to request another OTP until the waiting time has passed.' => 'Users will be unable to request another OTP until the waiting time has passed.',
  ...
  'Copy' => 'Copy',
  'Configure basic settings to manage your system preferences and defaults' => 'Configure basic settings to manage your system preferences and defaults',
  'Can Cancel' => 'Can Cancel',
  'Can Edit' => 'Can Edit',
  'Providers can Reply Review' => 'Providers can Reply Review',
  'If enabled, providers can review reply' => 'If enabled, providers can review reply',
  'Can Reply' => 'Can Reply',
  'Self Registration' => 'Self Registration',
  'Self Delete' => 'Self Delete',
  'Set up wallet limits and withdrawal rules for providers.' => 'Set up wallet limits and withdrawal rules for providers.',
  'Cash In Hand Setup' => 'Cash In Hand Setup',
  'Set the maximum amount of Cash in Hand a provider is allowed to keep. If maximum limit is exceeded provider will be suspended & will not receive any service requests' => 'Set the maximum amount of Cash in Hand a provider is allowed to keep. If maximum limit is exceeded provider will be suspended & will not receive any service requests',
  'Cash In Hand Limit Amount' => 'Cash In Hand Limit Amount',
  'It must be greater then' => 'It must be greater then',
  'You can see all the inactive providers who are suspended from' => 'You can see all the inactive providers who are suspended from',
  'Withdraw Amount Setup' => 'Withdraw Amount Setup',
  'Set the maximum & minimum withdraw amount during withdraw wallet balance. Providers can withdraw within Minimum and Maximum amount you set.' => 'Set the maximum & minimum withdraw amount during withdraw wallet balance. Providers can withdraw within Minimum and Maximum amount you set.',
  ...
  'page to work notifications.' => 'Page to work notifications.',
  'ReCAPTCHA' => 'ReCAPTCHA',
  'Enable this to require user verification via reCAPTCHA. Set up your Google credentials to activate the feature properly.' => 'Enable this to require user verification via reCAPTCHA. Set up your Google credentials to activate the feature properly.',
  'How to Get
                                        Credential' => 'How to Get
                                        Credential',
  'Site Key' => 'Site Key',
  'Enter the site key' => 'Enter the site key',
  'Secret Key' => 'Secret Key',
  'Enter the secret key' => 'Enter the secret key',
  'Google recaptcha instructions' => 'Google recaptcha instructions',
  ...
  'Please Select valid plan' => 'Please Select valid plan',
  'Servers PHP exec function is disabled check dependencies & start cron job manually in server' => 'Servers PHP exec function is disabled check dependencies & start cron job manually in server',
  ...
  'Your account is temporarily blocked. Please try again after 58 seconds' => 'Your account is temporarily blocked. Please try again after 58 seconds',
  'Your account is temporarily blocked. Please try again after 57 seconds' => 'Your account is temporarily blocked. Please try again after 57 seconds',
  'Your account is temporarily blocked. Please try again after 53 seconds' => 'Your account is temporarily blocked. Please try again after 53 seconds',
  'Payment_Information' => 'Payment Information',
  ...
  'No payment info added yet' => 'No payment info added yet',
  'Select payment Method' => 'Select payment Method',
  ...
  'The max booking amount must be greater than 0.' => 'The max booking amount must be greater than 0.',
  'By turning off availability mode, you will not get any new booking request from customers and customer will that you are currently unavailable to provide service' => 'By turning off availability mode, you will not get any new booking request from customers and customer will that you are currently unavailable to provide service',
  ...
  'Payment method name' => 'Payment method name',
  'Add payment method name.' => 'Add payment method name.',
  ...
  'Subscription Earning' => 'Subscription Earning',
  'Commission Earning' => 'Commission Earning',
  'Subscription Based Earning Statistics' => 'Subscription Based Earning Statistics',
  'All Times' => 'All Times',
  'Last Month' => 'Last Month',
  'This Year' => 'This Year',
  'Last Year' => 'Last Year',
  'Search package name' => 'Search package name',
  'Current Package' => 'Current Package',
  'Package Duration' => 'Package Duration',
  'Subscription Plan Renewed!' => 'Subscription Plan Renewed!',
  'We\'re excited to inform you that your subscription has been successfully renewed. You can continue to enjoy uninterrupted access to all premium features.' => 'We re excited to inform you that your subscription has been successfully renewed. You can continue to enjoy uninterrupted access to all premium features.',
  'Renew subscription packaged successfully' => 'Renew subscription packaged successfully',
);